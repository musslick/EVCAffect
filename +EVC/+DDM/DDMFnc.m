classdef DDMFnc < EVC.EVCFnc
    ...
    methods (Access = public)
        ...
        function out = getVal(this, varargin)
            ...
            if(this.type == this.INTENSITY2DDM_EFFICACY)
               out = intensityToDDM_Efficacy(this, EVCM); 
            end
            
            if(this.type == this.ACTUAL_EXPECTED)
                out = actualExpected(this, EVCM);
            end
...
%             out = middleOfRange + R1Delta + R2Delta;
        ...
        % param{2}: integer (refers to DDM proxy, see constants)
        % param{3}: EVC.EVCFnc (mapping function)
        function out = intensityToDDM_Efficacy(this, EVCM)
        ...
        % ACTUAL_EXPECTED... maps certain integer to DDM parameter in expected state
        % param{1}: integer (corresponds to true noise parameter)
        % param{2}: integer (corresponds to expected noise parameter)
        function out = actualExpected(this, EVCM)
